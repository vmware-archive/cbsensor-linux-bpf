...
#define bpf_probe_read_kerenl_str bpf_probe_read
#define bpf_probe_read_str bpf_probe_read
#elif LINUX_VERSION_CODE < KERNEL_VERSION(5, 5, 0)
#define bpf_probe_read_kerenl_str bpf_probe_read_str
#endif
...
{
	// Note: On some kernels bpf_probe_read_kerenl_str does not exist.  In this case it is
	...
	u8 result = bpf_probe_read_kerenl_str(data->fname, MAX_FNAME, ptr);
